...
public class Main {
    ...
    public void refreshValues() {
        ...
        double consQtyVal = getNumericVal(r.getAttribute("UsageMoUnit").toString());


        double wastageQtyVal = getNumericVal(r.getAttribute("ExtraUsage").toString());
        ...
        if(type.equals("Generic")){
            ...
            reqQtyVal =Math.ceil((double)(orderQtyVal * consQtyVal) * (1 + (wastageQtyVal /100)));
        }
       ...
       // System.out.println("Bom round up qty ---->"+MyMath.roundUp(reqQtyVal));
        try {
            r.setAttribute("NoOfGarment", new oracle.jbo.domain.Number(MyMath.roundUp(reqQtyVal)));
            
            r.setAttribute("BookedQty",new oracle.jbo.domain.Number(projPRQty +
                                                        addiQtyVal));
            r.setAttribute("Total",new oracle.jbo.domain.Number((projPRQty +
                                                         addiQtyVal) *
                                                        pricePerUnitVal));
            r.setAttribute("ProjPrQty",new oracle.jbo.domain.Number(projPRQty));
...
Integer.parseInt(r.getAttribute("SizeQuantity").toString());
    ...
    public void merchAction(ValueChangeEvent valueChangeEvent) {
        ...
        double alocateValCAL = getNumericVal(r.getAttribute("AllocateQty").toString());
        int flag = 0;
        ...
        double alocateQtyValCGL =
            getNumericVal(r.getAttribute("AlocateIntrCgl").toString());
        double alocateValCGL = getNumericVal(r.getAttribute("AlocateCgl").toString());
        ...
        double alocateValGFL = getNumericVal(r.getAttribute("AlocateInterGfl").toString());
    ...
    public void priceUnitAction(ValueChangeEvent valueChangeEvent) {
        ...
        double addiQtyVal = getNumericVal(r.getAttribute("AdditionalQty"));
        System.out.println("additional="+getNumericVal(r.getAttribute("AdditionalQty")));
        ...
        try {
            r.setAttribute("Total", new oracle.jbo.domain.Number(prQtyVal *
                                                        pricePerUnitVal));
        ...
        System.out.println("Actual PR qty sum in Bean ---------------->"+actualPrcntVal);
    ...
    public void additionalListener(ValueChangeEvent valueChangeEvent) {
        ...
        System.out.println("additional="+getNumericVal(valueChangeEvent.getNewValue()));
        double projPrQtyVal = getNumericVal(r.getAttribute("ProjPrQty"));
        double bomReqQtyVal = getNumericVal(r.getAttribute("NoOfGarment"));
        double prQtyVal = addiQtyVal + projPrQtyVal;
        System.out.println("prQtyVal="+prQtyVal);
        try {
            r.setAttribute("Total", new oracle.jbo.domain.Number(prQtyVal *
                                                        pricePerUnitVal));
            r.setAttribute("PrQty", new oracle.jbo.domain.Number(prQtyVal));
            r.setAttribute("BookedQty", new oracle.jbo.domain.Number(prQtyVal));
        } catch (SQLException e) {
        }
    ...
    public void resetLinesValues() {
        ...
        while (selectionIt.hasNext()) {
            ...
            try {
                ...
                selectedRow.setAttribute("NoOfGarment", MyMath.roundUp(reqQtyVal));
            ...
            try {
                r.setAttribute("NoOfGarment", new oracle.jbo.domain.Number(MyMath.roundUp(reqQtyVal)));
                r.setAttribute("PrQty", new oracle.jbo.domain.Number(projPRQty +
                                                            addiQtyVal));
                r.setAttribute("Total", new oracle.jbo.domain.Number((projPRQty +
                                                             addiQtyVal) *
                                                            pricePerUnitVal));
        ...
        while (it.hasNext()) {
           ...
           // System.out.println(itemid2 + "item ids" + itemId);
            if (itemid2.equals(itemId)) {
                System.out.println("Booked qty count Bean----------------->"+MyMath.numeric3(r.getAttribute(name)));
    ...
    public void addDeductAction(ValueChangeEvent valueChangeEvent) {
        ...
        addDeductQtyBind.setValue(MyMath.toNumber(actualQty - sizeWiseProjQty));
...
//    }
    ...
    public void setWhereClauseBPO(){
        ...
        /********************************/
        OperationBinding operationBinding = executeOperation("populateBPOLines1");
        operationBinding.execute();
   ...
   //     System.out.println("Level 1.2");
    ...
    public CellFormat getDataFormat(DataCellContext cxt)
    {
        ...
        Object total = qdr.getDimMember("BomRmlineId");
         ...
         if (total == null || total.toString().equals(" ") || total.toString().equals(""))
           {
...
//       am.getDBTransaction().
        ...
        try
        {
            ...
            while (st.hasMoreTokens())
            {
                ...
                if (lineNumber>1){
                    ...
                    switch (tokenNumber) {
                        case 1: rw.setAttribute("SizeVal", theToken);
                                break;
                        case 2: rw.setAttribute("SizeWiseOrderQty", theToken);
                                break;
                        case 3: rw.setAttribute("SizeWiseBomReqQty", theToken);
                                break;
                        case 4: rw.setAttribute("BookingPercent", theToken);
                                break;
                        case 5: rw.setAttribute("SizeWiseProjQty", theToken);
                                sizeProjQty = MyMath.numeric3(theToken);
                                System.out.println(sizeProjQty);
                        
                        case 6: rw.setAttribute("ActualQty", theToken);
                                sizeActualQty = MyMath.numeric3(theToken);
                                System.out.println(sizeActualQty);
                    
                        case 7: addDeductQty = sizeActualQty - sizeProjQty;
                                System.out.println(addDeductQty);
                                rw.setAttribute("AddDeduct", addDeductQty);
 
                        case 8: rw.setAttribute("Flag", "A");
            ...
            FacesContext fctx = FacesContext.getCurrentInstance();
            fctx.addMessage(sizeBreakdownTable.getClientId(fctx), new FacesMessage(FacesMessage.SEVERITY_ERROR,
    ...
    public void prPopupFetch(PopupFetchEvent popupFetchEvent) {
        ...
        po.setWhereClause("ITEM_ID = '"+ ro.getCurrentRow().getAttribute("InventoryItemId").toString()+"' AND BOM_NO = '"+ ho.getCurrentRow().getAttribute("BomNumber").toString()+"'");
        System.out.println("item_id"+ho.getCurrentRow().getAttribute("BomNumber").toString());
        System.out.println("bop"+ro.getCurrentRow().getAttribute("InventoryItemId").toString());
        po.executeQuery();
    }
    ...
    public void duplicateChecker(FacesContext facesContext,
        ...
        if(object != null){
               ...
               String bomid="",styleName="",styleNo="",season="",buyer="";
               if (orderType.equals("Style Based")){
                  
                   bomid = am.getCustMnjOntBomHeaderView1().getCurrentRow().getAttribute("BomId").toString();
                   
                 try{
                   styleName = am.getCustMnjOntBomHeaderView1().getCurrentRow().getAttribute("StyleNameNew").toString();
                 }catch(Exception e){
                      styleName="";
                  }
                try{
                   styleNo = am.getCustMnjOntBomHeaderView1().getCurrentRow().getAttribute("StyleNoC").toString();
                 }catch(Exception e){
                      styleNo="";
                  }
                try{
                   season = am.getCustMnjOntBomHeaderView1().getCurrentRow().getAttribute("SeasonC").toString();
                 }catch(Exception e){
                      season="";
                  }
                try{
                   buyer = am.getCustMnjOntBomHeaderView1().getCurrentRow().getAttribute("BuyerId").toString();
                 }catch(Exception e){
                      buyer="";
                  }
                   
                   String query="select count(*) as isExist from CUST_MNJ_ONT_BOM where STYLE_NO_C =? and STYLE_NAME_NEW=? and SEASON_C=? and BUYER_ID=? and ORDER_TYPE like 'Style%Based%' and BOM_ID<>?";
    ...
    public double getReqQty(){
        ...
        while (iter.hasNext()) {
            Row row = iter.next();
            try {
                temp = Double.parseDouble(row.getAttribute("SizeWiseBomReqQty").toString());
            } catch (Exception e) {
                temp = 0.0;
            }
            qty = qty + temp;
    ...
    public void saveAll(ActionEvent actionEvent) {
        System.out.println("into saveall......."); 
        try {
            am.getDBTransaction().commit();
            System.out.println("Commit Executed.......");
            am.getCustMnjOntBomRmlineLinesView1().executeQuery();
            System.out.println("CustMnjOntBomRmlineLinesView Executed......");
        } catch (Exception e) { 
            e.printStackTrace();
        } 
    }
    ...
    public void materialSheetOpenListener(DisclosureEvent disclosureEvent) {
        ...
        String stmt =
            "BEGIN :1 :=  MNJ_BOM_MATERIAL_SHEET(:2); end;";
    ...
    public void okButtonEventGenaratePRPopUp(ActionEvent actionEvent) {
        try {
                    ViewObject vo = am.getCustMnjOntBomRmlineLinesView1();
                //                System.out.println("checkBoxExists: " + checkBoxExists(vo));
                //                System.out.println("checkItemStatusMatches: " + checkItemStatus(vo));
                 ...
                 */
                    if (checkBoxExists(vo) != null && checkItemStatusMatches(vo).equals("true")){
                        System.out.println("enter in create pr condition.....");
                        createPR();
                        RichPopup popup = getGeneratePRPopUp(); // popup binding
                        popup.cancel();
                                        
                        }
                    else if (checkItemStatusMatches(vo).equals("false")){
                        showMessageWithSeverity("Found Different Item Status While Generating PR!", "warn");
                //                  AdfFacesContext.getCurrentInstance().addPartialTarget(generatePRPopUp);
                //                  RichPopup.PopupHints hints = new RichPopup.PopupHints();
                //                  warningPopUp1.show(hints);
                    }
                    else if (checkBoxExists(vo) == null){
                        showMessageWithSeverity("Please Select Any Item For Generating PR!", "info");
                    }
                } catch (Exception e) {
            ...
            try {
                ...
                for(Row eachRow : rowsArray){
                    ...
                    if (checkBoxValue.equals("Y")){
                        System.out.println("checkbox flag: " + eachRow.getAttribute("Flag").toString());
                        return flag;
        ...
        try {
            ...
            String checkBoxValue = null;
                ...
                for(Row eachRow : rowsArray){
                    ...
                    if (checkBoxValue.equals("Y")){
                        itemStatusArray[idx] = eachRow.getAttribute("Status").toString();
                        idx++;
                    }          
                }
                ...
                for (int count = 0; count < itemStatusArray.length; count++) {
                    ...
                    System.out.println("for index: " + count + ", value: " + itemStatusArray[count]);
                        if (count > 0){
                            if (itemStatusArray[count-1].toString().equals(itemStatusArray[count].toString())){
                            System.out.println(itemStatusArray[count-1] +", " + itemStatusArray[count] + " equals");
                            }
                            else {
                                System.out.println(itemStatusArray[count-1] +", " + itemStatusArray[count] + " not equals");
                                flag = "false";
                                return flag;
                            }
                        }
    ...
    public void setGeneratePRPopUp(RichPopup generatePRPopUp) {
        this.generatePRPopUp = generatePRPopUp;
    }

    public RichPopup getGeneratePRPopUp() {
        return generatePRPopUp;
    }

    public void cancelButtonEventGeneratePRPopUp(ActionEvent actionEvent) {
       try {
            RichPopup popup = getGeneratePRPopUp();
            popup.cancel();
